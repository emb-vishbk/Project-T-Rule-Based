"""Batch-generate Level-1 artifacts for all 10 Hz CAN sessions."""
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Level-1 artifact generation for all HDD 10 Hz CAN sessions. "
    ...
    parser.add_argument("--artifacts-root", default="artifacts", help="Root output directory (writes artifacts/level1_10hz/<session_id>/...).")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("Level-1 10Hz batch run configuration:")
    ...
    print(f"- sessions_with_existing_level1_segments: {existing_count}")
