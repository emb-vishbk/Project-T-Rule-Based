"""Batch-generate Level-2 artifacts for all 10 Hz CAN sessions."""
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Level-2 artifact generation for all HDD 10 Hz CAN sessions. "
    ...
    parser.add_argument("--artifacts-root", default="artifacts", help="Root output directory (writes artifacts/level2_10hz/<session_id>/...).")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("Level-2 10Hz batch run configuration:")
    ...
    print(f"- sessions_with_existing_level2_segments: {existing_count}")
