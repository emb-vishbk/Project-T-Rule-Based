"""Batch-generate Level-4 (SHARP/SMOOTH) artifacts for all 20 Hz CAN sessions."""
...
def _resolve_level3_artifacts_root(args: argparse.Namespace) -> Path:
    ...
    return Path(args.artifacts_root) / "level3_20hz"
...
def _resolve_level4_output_root(args: argparse.Namespace) -> Path:
    ...
    return Path(args.artifacts_root) / "level4_20hz"
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Level-4 SHARP/SMOOTH inference for all HDD 20 Hz CAN sessions. "
    ...
    parser.add_argument("--level3-artifacts-root", default=None, help="Override Level-3 artifacts root (default: <artifacts-root>/level3_20hz).")
    parser.add_argument("--level4-output-root", default=None, help="Override Level-4 output root (default: <artifacts-root>/level4_20hz).")
    ...
    parser.add_argument("--fs-hz", type=float, default=20.0, help="Sampling rate in Hz (default: 20.0).")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("Level-4 20Hz batch run configuration:")
